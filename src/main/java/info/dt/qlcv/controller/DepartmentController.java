...
public class DepartmentController {
    ...
    public ModelAndView createDepartment(@Valid DepartmentRequest departmentRequest , BindingResult bindingResult)
    {
    ...
    public ModelAndView loadDepartment(HttpServletResponse response, @CookieValue(value = "token", defaultValue = "") String token, @CookieValue(value = "userId", defaultValue = "-1") String idUser)
    {
    ...
    public ModelAndView getDepartmentDetailByID(@PathVariable("id") String id, HttpServletResponse response, @CookieValue(value = "token", defaultValue = "") String token,
